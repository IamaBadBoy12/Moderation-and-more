...
module.exports = {
    ...
    run: async (bot, message, args) => {
        ...
        try {
            ...
            return message.channel.send("❌ Error - `Missing Permissions or Channel Doesn't Exist`, if you think this is an error, type `>invite` to get my support server link to get help there!")
        }
    }
}
